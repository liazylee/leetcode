...
<div><div>Related Topics</div><div><li>Array</li><li>Hash Table</li><li>Sorting</li><li>Counting</li></div></div><br><div><li>👍 1801</li><li>👎 129</li></div>
"""
...
class Solution:
    def findWinners(self, matches: List[List[int]]) -> List[List[int]]:
        winers,loser,table=set(),set(),{}
        for i,j in matches:
            winers.add(i)
            table[j]=table.get(j,0)+1
            loser.add(j)
        return [sorted(list(winers-loser)),sorted([k for k,v in table.items() if v==1])]
